...
const EditNote = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      const res = await fetch(`${backendURL}/notes/edit/${id}`, {
        method: 'PATCH',
        headers: {
      ...
      setPopup({
        type: 'error',
        message: 'Network error while updating note'
      });
    } finally {
      setSaving(false);
    }
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden animate-scale-in">
            <div className="p-6 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white">
              <h3 className="text-2xl font-bold">💾 Save Changes?</h3>
            </div>
            <div className="p-6">
              <p className="text-gray-700 text-lg mb-6">
                Are you sure you want to save the changes to this note?
              </p>
              <div className="flex gap-3">
                ...
                <button
                  onClick={handleSave}
                  className="flex-1 py-3 rounded-lg font-semibold text-white bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 transition"
                >
                  Save
                </button>
              </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden animate-scale-in">
            <div className="p-6 bg-gradient-to-r from-orange-500 to-orange-600 text-white">
              <h3 className="text-2xl font-bold">⚠ Discard Changes?</h3>
            </div>
            <div className="p-6">
              <p className="text-gray-700 text-lg mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl md:text-2xl font-bold text-emerald-600">Edit Mode</h1>
            </div>
